...
%     data(1,:)=randint(1,N);%generating bits
    ...
    transmittedSamples = transpose(rectpulse( double(Tx_zp).', numberOfSamplesPerBit ));
...
%  concatenatedTime_TransmittedSamples= transmittedSamples(1,:)' ;
    ...
    optsys.Open('C:\Users\hp\Desktop\Coherent 4 QAM.osd');
